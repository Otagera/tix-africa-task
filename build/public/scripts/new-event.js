var NewEvent = /** @class */ (function () {
    function NewEvent() {
        var _this = this;
        this.dateTimeType = 'datetime-local';
        this.form = document.querySelector('#new-event-form');
        ...
        this.onFormSubmit = function () {
            _this.form && _this.form.addEventListener('submit', function (e) {
                ...
                if (_this.eventNameInput && _this.eventNameInput.value
                    ...
                    && _this.eventTypeInput && _this.eventTypeInput.value) {
                    _this.getNewEventData();
                    _this.newEventRequest();
                }
            });
        };
        ...
        this.newEventRequest = function () {
            $.post('/api/event/new', _this.newEventData)
